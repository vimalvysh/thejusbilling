...
import logo from "../../assets/images/logo/thejus.jpg";
...
function Sidenav({ color }) {
  ...
  const tables = [
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" key={0}>
      <path d="M9 2C8.44772 2 8 2.44772 8 3C8 3.55228 8.44772 4 9 4H11C11.5523 4 12 3.55228 12 3C12 2.44772 11.5523 2 11 2H9Z" fill={color}></path>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
  ...
  // ToDo : To delete.
  const handleGetSidebaritems = (type) => {
    if (type === "old") {
      return (
          ...
          <Menu.Item key="2">
            <NavLink to="/new-order">
              <span
                className="icon"
                style={{
                  background: page === "new-order" ? color : "",
                }}
              >
                {tables}
              </span>
              <span className="label">Create New Order</span>
            </NavLink>
          </Menu.Item>
          <Menu.Item key="3">
            <NavLink exact to="/">
              ...
              <span className="label">List Of Oder Details</span>
            </NavLink>
          </Menu.Item>
          <Menu.Item key="4">
            <NavLink exact to="/">
              ...
              <span className="label">GSTN Info</span>
            </NavLink>
          </Menu.Item>
          <Menu.Item key="5">
            <NavLink exact to="/">
  ...
  return (
    <>
      <div className="brand ">
        <img src={logo} alt="" />
        {/* <span>Thejus Billing</span> */}
      </div>
      <hr />
      {handleGetSidebaritems("new")}
